        ...
        <section className="mx-6 md:mx-10 my-2 md:my-8 p-2 md:px-4">
            ...
            <div className="flex flex-col lg:flex-row-reverse items-center justify-between gap-6 lg:gap-8">
                ...
                <div className="flex-1 flex flex-col gap-2">
                    ...
                    <form onSubmit={handleSubmit(handleLogin)} className="w-full flex flex-col gap-6 px-4 lg:px-8 py-4 lg:py-6 shadow-lg shadow-nexus-secondary border border-nexus-primary rounded-md">
                        ...
                        <div className="flex flex-col gap-3">
                            <div className="flex items-center gap-2 pl-2 bg-transparent rounded-lg border border-nexus-primary">
                                ...
                                <input
                                    ...
                                    className="px-2 rounded-r-lg py-1 bg-transparent w-full border-l border-nexus-primary focus:outline-0" type="email" name="email" id="email" placeholder="Your Email" />
                            </div>
                            {
                            ...
                            <div className="flex items-center gap-2 bg-transparent  pl-2 rounded-lg border border-nexus-primary">
                                ...
                                <div className="relative w-full">
                                    ...
                                    <input
                                        ...
                                        className="px-2 rounded-r-lg py-1 bg-transparent w-full border-l border-nexus-primary focus:outline-0" type={showPassword ? "text" : "password"} name="password" id="password" placeholder="Your Password" />
                        ...
                        <p className="text-center text-sm md:text-base font-medium">New to this site? <Link className="hover:pl-4 text-[#3c5cc3] font-bold hover:text-nexus-primary transition-all duration-500" to={'/register'}>Register Here!</Link></p>
                    </form>
                </div>
            </div>
        </section>
