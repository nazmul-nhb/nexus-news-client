                ...
                <div className="flex-1 flex flex-col gap-2">
                    ...
                    <form onSubmit={handleSubmit(handleLogin)} className="w-full flex flex-col gap-6 px-4 lg:px-8 py-4 lg:py-6 shadow-lg shadow-[#8689ee] border border-furry rounded-md">
                        ...
                        <div className="flex flex-col gap-3">
                            <div className="flex items-center gap-2 pl-2 bg-transparent rounded-lg border border-furry">
                                ...
                                <input
                                    ...
                                    className="px-2 rounded-r-lg py-1 bg-transparent w-full border-l border-furry focus:outline-0" type="email" name="email" id="email" placeholder="Your Email" />
                            </div>
                            {
                            ...
                            <div className="flex items-center gap-2 bg-transparent  pl-2 rounded-lg border border-furry">
                                ...
                                <div className="relative w-full">
                                    ...
                                    <input
                                        ...
                                        className="px-2 rounded-r-lg py-1 bg-transparent w-full border-l border-furry focus:outline-0" type={showPassword ? "text" : "password"} name="password" id="password" placeholder="Your Password" />
