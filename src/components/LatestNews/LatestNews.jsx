    ...
    return (
        <div className="flex-grow w-full lg:w-1/3 ">
            ...
            <div className="grid md:grid-cols-2 gap-3">
                {
                    latestNews?.map(article => <div onClick={() => handleGoToArticleDetails(article._id)} className="cursor-pointer border border-nexus-secondary shadow-md shadow-nexus-secondary p-2" key={article._id}>
                        <div className=" hover:scale-[1.03] transition-all duration-500 hover:text-nexus-primary">
