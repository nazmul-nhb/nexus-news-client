...
const SiteTitle = () => {
    ...
    return (
        <div className='max-w-[1920px] flex flex-col items-stretch justify-center gap-1 mx-auto border-b border-nexus-secondary px-3 py-2 bg-nexusBG bg-opacity-100 z-50 text-nexus-secondary overflow-hidden'>
