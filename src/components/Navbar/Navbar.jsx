...
const Navbar = () => {
    ...
    return (
        <nav className="max-w-screen-2xl flex items-center gap-0 md:gap-4 mx-auto shadow-md px-3 py-2 md:px-14 sticky top-0 bg-nexusBG bg-opacity-100 z-50 text-nexus-secondary transition-all duration-1000">
