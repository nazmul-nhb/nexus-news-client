	...
	return (
		<section className="w-full mx-auto ">
			...
			<SectionHeader
				...
				subHeading={
					'We recognize our responsibility to protect and preserve the environment. Our mission is to reduce our environmental impact through sustainable practices and to support environmental causes through responsible journalism.'
				}
			/>
